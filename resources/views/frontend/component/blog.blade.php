                    ...
                    <div class="col-md-6 col-6  ">
                        <div class="blog_big_box" data-aos-once="true" data-aos="fade-up">
                            ...
                            <div class="blog_content">
                                ...
                                <a
                                    href="{{ url(route('blog.detail', ['slug' => strtolower(str_replace(' ', '-',$blog[0]->slug))] )) }}">View
                                    More</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-6">
                        <div class="blog_big_box" data-aos-once="true" data-aos="fade-up">
                            ...
                            <div class="blog_content">
                                ...
                                <a
                                    href="{{ url(route('blog.detail', ['slug' => strtolower(str_replace(' ', '-',$blog[1]->slug))] )) }}">View
                                    More</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-4 px0 ">
                ...
                <div class="blog_right_box" data-aos-once="true" data-aos="fade-up">
                    ...
                    <div>
                        ...
                        <a
                            href="{{ url(route('blog.detail', ['slug' => strtolower(str_replace(' ', '-',$row->slug))] )) }}">View
                            More</a>
                    </div>
                </div>
