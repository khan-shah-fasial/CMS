            ...
            <div class="modal-body ">
                <div class="career_popup_form">
                    ...
                    <form class="contact_form">
                        ...
                        <div class="d-flex align-items-center gap-3 mb-3">
                            <input class="form-control" type="text" placeholder="Write Your Phone No"
                                data-aos-once="true" data-aos="fade-up" />
                            <select class="form-select" data-aos-once="true" data-aos="fade-up">
                        ...
                        <input class="form-control" type="text" placeholder="Brief description of your legal issue"
                            data-aos-once="true" data-aos="fade-up" />
