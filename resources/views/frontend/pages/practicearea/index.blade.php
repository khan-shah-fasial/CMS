    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <a href="">
                    <div class="practice_w_card d-flex align-items-center justify-content-center m-4">
                        <img src="/assets/frontend/images/p_1.png" alt="" class="mb-5" data-aos-once="true"
                            data-aos="fade-up" />
            ...
            <div class="col-md-4">
                <a href="">
                    <div class="practice_w_card d-flex align-items-center justify-content-center m-4">
                        <img src="/assets/frontend/images/p_2.png" alt="" class="mb-5" data-aos-once="true"
                            data-aos="fade-up" />
                        <h1 class="heading" data-aos-once="true" data-aos="fade-up">Setting Up In India</h1>
                    </div>
                </a>
            ...
            <div class="col-md-4">
                <a href="">
                    <div class="practice_w_card d-flex align-items-center justify-content-center m-4">
                        <img src="/assets/frontend/images/p_3.png" alt="" class="mb-5" data-aos-once="true"
                            data-aos="fade-up" />
                        <h1 class="heading" data-aos-once="true" data-aos="fade-up">Setting Up In India</h1>
                    </div>
                </a>
            ...
            <div class="col-md-4">
                <div class="practice_w_card d-flex align-items-center justify-content-center m-4">
                    <img src="/assets/frontend/images/p_4.png" alt="" class="mb-5" data-aos-once="true"
                        data-aos="fade-up" />
                    <h1 class="heading" data-aos-once="true" data-aos="fade-up">Setting Up In India</h1>
                </div>
            </div>
            <div class="col-md-4">
                <div class="practice_w_card d-flex align-items-center justify-content-center m-4">
                    <img src="/assets/frontend/images/p_5.png" alt="" class="mb-5" data-aos-once="true"
                        data-aos="fade-up" />
                    <h1 class="heading" data-aos-once="true" data-aos="fade-up">Setting Up In India</h1>
                </div>
            </div>
            <div class="col-md-4">
                <div class="practice_w_card d-flex align-items-center justify-content-center m-4">
                    <img src="/assets/frontend/images/p_6.png" alt="" class="mb-5" data-aos-once="true"
                        data-aos="fade-up" />
                    <h1 class="heading" data-aos-once="true" data-aos="fade-up">Setting Up In India</h1>
                </div>
            </div>
