    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <h2 class="heading" data-aos-once="true" data-aos="fade-up">Awards & Recognitions</h2>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          ...
          <h2 class="heading" data-aos-once="true" data-aos="fade-up">Ahlawat & Associates</h2>
          ...
          <div class="d-flex align-items-center gap-4">
            <p data-aos-once="true" data-aos="fade-up">
              ...
              <span>Praesent feugiat sem mattis.</span>
            </p>
            <p data-aos-once="true" data-aos="fade-up">
              <span><img src="/assets/frontend/images/check.png" alt="" /></span>
              <span>Praesent feugiat sem mattis.</span>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <h1 class="practice_main_heading" data-aos-once="true" data-aos="fade-up" >
            Our <span style="color: #e36d6a"> Practice</span> Area
          </h1>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-12">
          <div
            class="d-flex align-items-center justify-content-center mt-2"data-aos-once="true" data-aos="fade-up"
          >
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="news_box me-5">
            <h1 class="heading" data-aos-once="true" data-aos="fade-up">Best Law firm in India</h1>
        ...
        <div class="col-md-6">
          <div class="news_box ms-5">
            <h1 class="heading" data-aos-once="true" data-aos="fade-up">Top Lawyer in Delhi</h1>
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <h1 class="heading" data-aos-once="true" data-aos="fade-up">
            ...
            for our
            <span style="color: #e36d6a"> Experts </span>
          </h1>
        </div>
        <div class="col-md-6">
          <p class="desc" data-aos-once="true" data-aos="fade-up">
      ...
      <div class="row">
        <div class="col-md-12">
          <div
            ...
            id="banner_slider_carousel"
          >
            <div class="item" data-aos-once="true" data-aos="fade-up">
              <div class="team_box">
                <img
                  src="/assets/frontend/images/team_1.png"
                  alt=""
                  class="team_img"
                />
                <div
                  class="d-flex align-items-center justify-content-center team_bio_container"
                >
            ...
            <div class="item" data-aos-once="true" data-aos="fade-up">
              <div class="team_box">
                <img
                  src="/assets/frontend/images/team_2.png"
                  alt=""
                  class="team_img"
                />
                <div
            ...
            <div class="item" data-aos-once="true" data-aos="fade-up">
              <div class="team_box">
                <img
                  src="/assets/frontend/images/team_3.png"
                  alt=""
                  class="team_img"
                />
                <div
  ...
  <section class="media">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div
            class="underline_heading d-flex align-items-center justify-content-center mt-4"
          >
            <h6 class="main_heading text-center" data-aos-once="true" data-aos="fade-up">Media</h6>
          </div>
          <h1 class="heading" data-aos-once="true" data-aos="fade-up">Media Coverage</h1>
        </div>

        <div class="col-md-12">
          <div
            class="owl-carousel owl-theme"
            id="media_slider_carousel"
          >
            <div class="item">
      ...
      <div class="row">
        <div class="col-md-8">
          ...
          <h1 class="heading" data-aos-once="true" data-aos="fade-up">
            ...
            from our latest <span style="color: #e36d6a">Blog</span>
          </h1>
          <div class="row">
            <div class="col-md-6">
        ...
        <div class="col-md-4">
          <h2 class="right_heading">
            ...
            <span style="color: #e36d6a">News</span>
          </h2>
