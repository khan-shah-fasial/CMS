...
@section('page.title', 'Deal Updates | Ahlawat & Associates')

@section('page.description', 'Alhawat associates regularly update deal update covering various legal fields in which their lawyers specialize.')
