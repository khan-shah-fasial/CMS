...
<body>
    ...
    <script src="{{ static_asset('assets/js/aiz-core.js') }}"></script>
        <script src="{{ static_asset('assets/js/jquery.sticky.js') }}"></script>
    ...
    <script>
        ...
        function getVariantPrice(){
            ...
            //$('.slick-slide[data-slick-index]').css('display','none');
                ...
                $.ajax({
                   ...
                   success: function(data){
                        ...
                        $('.product-gallery-thumb .carousel-box').each(function (i) {
                            ...
                            /*
                            let text1 = $(this).data('variation') +'';

                            var show = text1.includes(color);
                                
                            $('.slick-active[data-slick-index]').css('display','block');
                                
                            slick-current slick-active
                                
                            if(show == true){
                                $('.slick-slide[data-slick-index="'+i+'"]').css('display','inline-block');
                                
                            } else {
                                $('.slick-slide[data-slick-index="'+i+'"]').css('display','none');
                            }
